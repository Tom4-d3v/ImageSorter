...
package Source.com.drew.metadata.adobe;

import static Source.com.drew.metadata.adobe.AdobeJpegDirectory.TAG_COLOR_TRANSFORM;
import static Source.com.drew.metadata.adobe.AdobeJpegDirectory.TAG_DCT_ENCODE_VERSION;

import Source.com.drew.lang.annotations.Nullable;
import Source.com.drew.metadata.TagDescriptor;

/**
 * Provides human-readable string versions of the tags stored in an
 * AdobeJpegDirectory.
 */
...
public class AdobeJpegDescriptor extends TagDescriptor<AdobeJpegDirectory> {
	...
	private String getDctEncodeVersionDescription() {
		...
		return value == null ? null : value == 0x64 ? "100" : Integer.toString(value);
	}

	@Nullable
	private String getColorTransformDescription() {
		return getIndexedDescription(TAG_COLOR_TRANSFORM, "Unknown (RGB or CMYK)", "YCbCr", "YCCK");
	}
}
