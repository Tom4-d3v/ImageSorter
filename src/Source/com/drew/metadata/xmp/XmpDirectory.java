 ...
 */
package Source.com.drew.metadata.xmp;
 ...
 * <p />
 * XMP uses a namespace and path format for identifying values, which does not
 * map to metadata-extractor's integer based tag identifiers. Therefore, XMP
 * data is extracted and exposed via {@link XmpDirectory#getXMPMeta()} which
 * returns an instance of Adobe's {@link XMPMeta} which exposes the full XMP
 * data set.
 *
...
public class XmpDirectory extends Directory {
	 ...
	 * <p>
	 * This is required because XMP properties are represented as strings, whereas
	 * the rest of this library uses integers for keys.
	 */
	@NotNull
	...
	/**
	 * Gets the XMPMeta object used to populate this directory. It can be used for
	 * more XMP-oriented operations. If one does not exist it will be created.
	 */
	@NotNull
